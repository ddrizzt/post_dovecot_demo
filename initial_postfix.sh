...
#Init RDS data
echo 'DROP DATABASE IF exists servermail; CREATE DATABASE servermail;' | mysql -hdovecotauth.cocsmvpnuzlc.us-west-2.rds.amazonaws.com -udovecot -pdovecot123 -P3306
cd /mnt/post_dovecot_demo/ && cat rds_mysql_init.sql | perl -ne ' chomp($_);  $str = $_; $str =~ s/\[DOMAIN\]/$ENV{'DOMAIN'}/g; print "$str\n";' > init.sql
mysql -hdovecotauth.cocsmvpnuzlc.us-west-2.rds.amazonaws.com -udovecot -pdovecot123 -P3306 servermail < init.sql
